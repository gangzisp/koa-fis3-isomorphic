...
define('label-list', function(require, exports, module) {
  ...
  var labelList = {
    ...
    _renderData: function(data) {
      this.$el.find('.ui-label-list').html(labelTpl({
        keywords: data
      }));
    },
...
define('page-menu.tpl', function(require, exports, module) {
  ...
  return function(it, opt) {
    ...
    with(it) {
      ...
      var item;
      for (var i = 0, len = pageMenu.length; i < len; i++) {
        loop.index = i;
        item = pageMenu[i];
        if (loop.index === 0) {
          loop.first === true;
        ...
        _$out_.push(' <li class="page-item ');
        if (loop.first) {
          _$out_.push('first');
        } else {
...
define('banner-2.tpl', function(require, exports, module) {
  ...
  return function(it, opt) {
    ...
    with(it) {
      ...
      var item;
      for (var i = 0, len = banner2.length; i < len; i++) {
        loop.index = i;
        item = banner2[i];
        if (loop.index === 0) {
          loop.first === true;
...
define('banner-3.tpl', function(require, exports, module) {
  ...
  return function(it, opt) {
    ...
    with(it) {
      ...
      var item;
      for (var i = 0, len = banner3.list.length; i < len; i++) {
        loop.index = i;
        item = banner3.list[i];
        if (loop.index === 0) {
          loop.first === true;
...
define('panel-3.tpl', function(require, exports, module) {
  ...
  return function(it, opt) {
    ...
    with(it) {
      var _$out_ = [];
      _$out_.push('<h2 class="ui-arrowlink" data-href="', panel3.url, '"> ', panel3.title, '<span class="ui-panel-subtitle">', panel3.total || 0, '条</span></h2><ul class="ui-grid-trisect"> ');
      var loop = {
        index: 0,
        first: true
      };
      var item;
      for (var i = 0, len = panel3.list.length; i < len; i++) {
        loop.index = i;
        item = panel3.list[i];
        if (loop.index === 0) {
          loop.first === true;
...
define('tab-recmend.tpl', function(require, exports, module) {
  ...
  return function(it, opt) {
    ...
    with(it) {
      ...
      var item;
      for (var i = 0, len = tabRecmend.list.length; i < len; i++) {
        loop.index = i;
        item = tabRecmend.list[i];
        if (loop.index === 0) {
          loop.first === true;
        } else {
          loop.first = false;
...
define('tab-more.tpl', function(require, exports, module) {
  ...
  return function(it, opt) {
    ...
    with(it) {
      ...
      var item;
      for (var i = 0, len = tabMore.list.length; i < len; i++) {
        loop.index = i;
        item = tabMore.list[i];
        if (loop.index === 0) {
          loop.first === true;
